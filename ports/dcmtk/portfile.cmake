...
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
    if(NOT HOST_TRIPLET STREQUAL TARGET_TRIPLET)
        if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
            set(DCMTK_SYSTEM_PROCESSOR x86_64)
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
            set(DCMTK_SYSTEM_PROCESSOR x86)
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
            set(DCMTK_SYSTEM_PROCESSOR arm64)
        endif()
        set(DCMTK_CROSS_OPTIONS "-DCMAKE_CROSSCOMPILING_EMULATOR=\"\"arch;-arch;${DCMTK_SYSTEM_PROCESSOR}\"\"")
    endif()
endif()
